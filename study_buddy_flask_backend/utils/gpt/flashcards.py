...
def generate_flashcards(text, level="Basic"):
    ...
    if level == "basic":
        prompt = (
            ...
            f"Do NOT ask about theorems, formulas, or facts unless you provide all necessary information in the question itself. If you reference a theorem (e.g., 'Theorem 6'), you MUST state the complete theorem in the question.\n"
